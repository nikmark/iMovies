...
public class CertificateBean implements Serializable {
    ...
    private IMoviesLogger log = new IMoviesLogger("main.beans.CertificateBean");
    ...
    public String revokeCertificate() {
        System.out.println("Revoke Certificate di beans.CertificateBean. Nome file da revocare= " + getSelectedUserCert().getNameFile());
    ...
    public String deleteCertificate() {
        ...
        CertificateBean cb = (CertificateBean) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("beans.CertificateBean");
        cb.getUCert().remove(getSelectedUserCert());
        FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("beans.CertificateBean", cb);
        return "refresh";
    ...
    public void refreshBean() {
        try {
            FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("beans.LoginBean");
            System.out.println(((LoginBean) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("beans.LoginBean")).getUsername());
            this.uCert = utils.Utilities.getCertificateUser(((LoginBean) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("beans.LoginBean")).getUsername(),
                    ((LoginBean) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("beans.LoginBean")).isAdmin());
