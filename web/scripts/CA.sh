...
-sign|-signreq)
openssl ca $SSLEAY_CONFIG -policy policy_anything -passin file:$CATOP/private/pass -batch -in $CATOP/certs/$2.csr -startdate $ -enddate $ -out /var/lib/tomcat7/webapps/iMovies/certs/$2.pem 
