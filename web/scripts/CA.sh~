...
echo $2 >> /var/lib/tomcat7/webapps/iMovies/subje
    $REQ -new -keyout /var/lib/tomcat7/webapps/iMovies/certs/private/$3.key -passin file:$4 -passout file:$4 -out /var/lib/tomcat7/webapps/iMovies/certs/cert/$3.csr $DAYS -subj "$2"
    RET=$?
...
-sign|-signreq)
    $CA -passin file:$CATOP/private/pass -policy policy_anything -batch -out /var/lib/tomcat7/webapps/iMovies/certs/cert/$3.pem -in $2
